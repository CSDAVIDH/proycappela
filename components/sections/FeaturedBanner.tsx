  ...
  return (
    <section className="overflow-hidden bg-sand">
      <div className="grid lg:grid-cols-2 min-h-[600px]">
        ...
        {/* Left – content */}
        <div className="flex items-center justify-center px-8 lg:px-16 py-20 lg:py-0 bg-gradient-to-br from-sand via-sand to-nude/30">
          <div className="max-w-lg">
            <p className="font-body text-terracota text-[10px] tracking-[0.55em] uppercase mb-5">
              Temporada 2025
            </p>
            <h2 className="font-heading text-4xl lg:text-5xl text-chocolate font-medium leading-tight mb-6">
            ...
            {/* Stats */}
            <div className="flex gap-10 pt-8 border-t border-nude/60">
              {featuredStats.map((s) => (
                <div key={s.label}>
